...
[^11]: {% cite 'Thiboutot 2020' %}. For further discussions of Egyptian blue in mummy portraits, see {% cite 'Dyer and Newman 2020' '59–61' %}; {% cite 'Ganio et al. 2015' %}; {% cite 'Mayberger et al. 2020' '82' %}; and {% cite 'Vak, Iannacone, and Uhlir 2020' '137–38' %}.
