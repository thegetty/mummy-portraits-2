...
{% figure 'fig-4-3' 'screen-side-by-side pdf-3q3in-height' %}
...
{% figure 'fig-4-10' 'pdf-float-top' %}

{% figure 'fig-4-11' 'pdf-float-top' %}
...
{% figure 'fig-4-15' 'pdf-float-top' %}

{% figure 'fig-4-16' 'pdf-float-top' %}
...
Copper-based materials were the traditional green pigments used throughout Pharaonic Egypt. Celadonite, a phyllosilicate of potassium and iron, is not native to Egypt but has two well-known sources in the Mediterranean: Italy (Verona) and the island of Cyprus.[^34] It sees widespread use in Hellenistic Cyprus, Israel, and Greece[^35] and has been identified on other second-century CE Roman-period painted shrouds, such as a Hathor-type shroud (EA68950),[^36] an Osiris-type shroud (25.184.20),[^37] and a fragment of a painted shroud (X.390).[^38] Thus, in Egypt, celadonite is readily accepted and integrated into the existing palette of Egyptian artisans, despite being nontraditional and of foreign origin. 
...
[^4]: {% cite 'Lajtar 2005' %}; {% cite 'Lajtar 2012' %}.

[^5]: {% cite 'Lajtar 2005' '75' %}; {% cite 'Lajtar 2012' '180' %}.

[^6]: {% cite 'Lajtar 2012' '173–74' %}.

[^7]: {% cite 'Clarysse 1995' %}.

[^8]: {% cite 'Lajtar 2012' '179' %}.

[^9]:  {% cite 'Riggs 2006' %}.

[^10]: {% cite 'Ikram and Dodson 1998' %}.

[^11]: {% cite 'Jimenez 2014' '17, 19' %}.

[^12]: {% cite 'Jimenez 2014' '20, 22' %}.

[^13]: {% cite 'Riggs 2005' '177' %}; {% cite 'Schreiber, Vasáros, and Almásy 2013' '206' %}.

[^14]: {% cite 'Schreiber, Vasáros, and Almásy 2013' %}.

[^15]: {% cite 'Riggs 2005' %}.

[^16]: {% cite 'Bierbrier 2012' %}.

[^17]: {% cite 'Bierbrier 2012' '52, 114, 579' %}.

[^18]: The remaining portion was gifted to the British Museum.

[^19]: {% cite 'Smith 1957' %}.

[^20]: {% cite 'Hillyer 1984' %}; {% cite 'Vandenbeusch 2022' %}.

[^21]: {% cite 'Haugan and Holst 2013' %}.

[^22]: {% cite 'Pagès-Camagna and Guichard 2010' %}.
...
[^24]: {% cite 'Zviagina, Drits, and Dorzhieva 2020' %}.
...
[^27]: {% cite 'Newman and Gates 2020' %}.

[^28]: {% cite 'Smith 1957' '40' %}.

[^29]: {% cite 'Jimenez 2014' %}.

[^30]: {% cite 'Jimenez 2014' '4' %}.

[^31]: {% cite 'Jimenez 2014' '183' %}.

[^32]: {% cite 'Ikram and Dodson 1998' '157, 160' %}.

[^33]: {% cite 'Pagès-Camagna and Guichard 2010' '26–28' %}.

[^34]: {% cite 'Roberts 2020' %}; {% cite 'Pagès-Camagna and Guichard 2010' '30' %}; {% cite 'Kakoulli 2009' %}.

[^35]: {% cite 'Kakoulli 2009' '48' %}.

[^36]: {% cite 'Hillyer 1984' '8' %}; {% cite 'Scott 2010' %}. Object currently housed at the British Museum: <https://www.britishmuseum.org/collection/object/Y_EA68950>.
...
[^38]: {% cite 'Roberts 2020' '40' %}. Object currently housed at The Metropolitan Museum of Art, New York: <https://www.metmuseum.org/art/collection/search/256830>.

[^39]: {% cite 'Walton and Trentelman 2009' %}.

[^40]: {% cite 'Svoboda and Walton 2010' %}.
