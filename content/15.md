...
<figure style="column-span: all; -prince-float: top;">
{% figuregroup '2' 'fig-15-6-a, fig-15-6-b' %}
</figure>
...
{% figure 'fig-15-7' 'is-table-scale-8' %}
...
<figure style="column-span: all; -prince-float: top;">
{% figuregroup '3' 'fig-15-8-a, fig-15-8-b, fig-15-8-c' %}
</figure>
...
<figure style="column-span: all; -prince-float: top;">
{% figuregroup '2' 'fig-15-9-a, fig-15-9-b' %}
</figure>
...
[^32]: Identification through vis-NIR FORS and FTIR for DIA painting (see APPEAR database). For wax identification in the Walters painting see {% cite 'Radpour et al. 2022' '8–9' %}; {% cite 'Ramer 1979' '6–7' %}; and {% cite 'Mazurek 2020' '142–47' %}.

[^33]: For a more detailed description of the painting materials and techniques used in the Walters funerary portrait see {% cite 'Radpour et. al. 2022' '6–14' %}. All technical information listed here is based on the findings published in this article. For further information on the making of the Detroit portrait see {% cite 'Bisulca et al. 2021' '6–19' %}.

[^34]: Review of data available on APPEAR database. See also {% cite 'Thompson 1976A' '115–19' %}.

[^35]: {% cite 'Bruhn 1993' '30–32' %}.

[^36]: The wood from the DIA panel was radiocarbon dated at the Accelerator Mass Spectrometry Laboratory, University of Arizona. The results are a calendar date range of 132 calCE to 335 calCE (95%), 214 calCE to 315 calCE (68%). See {% cite 'Bisulca et al. 2021' '11' %}.
...
[^39]: The gesso is consistent with calcium carbonate in a proteinaceous binder based on vis-NIR FORS. Gessos made with calcium carbonate appear to be common in ancient Egyptian artefacts, possibly more so than gypsum. See {% cite 'Hatchfield and Newman 1991' '34–38' %}.

[^40]: {% cite 'Radpour et. al. 2022' '9' %}.

[^41]: {% cite 'Radpour et. al. 2022' '8' %}.

[^42]: {% cite 'Bruhn 1993' '10–16' %}.

[^43]: {% cite 'Bruhn 1993' '32' %}. Bruhn notes the modeling of the necklace could also indicate an embossed gold neck ring.
...
[^46]: For the historic image, see <https://art.thewalters.org/detail/30478/mummy-portrait-of-a-woman-from-fayum-egypt/>.

[^47]: For more on the restoration and the resulting misrepresentation of the garment see {% cite 'Bisulca et al. 2021' '12–14' %}.

[^48]: {% cite 'Stein and Corcoran 2020' '128–31' %}.

[^49]: Henry Walters purchased altogether four Roman Egyptian funerary portraits from Kelekian in 1912. Walters Art Museum, Baltimore 32.4, 32.5, 32.6, 32.7.

[^50]: {% cite 'Cartwright 2022' %}.

[^51]: {% cite 'Riggs 2012' '664' %}.

[^52]: {% cite 'Kersel 2021' '263–64' %}; and {% cite 'Hopkins, Costello, and Davis 2021' '1–25' %}.
