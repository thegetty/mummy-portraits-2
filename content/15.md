...
[^26]: For example: review of data available on APPEAR database, accessed December 28, 2022, <https://www.appeardatabase.org>; {% cite 'Susanne Ebbinghaus et. al 2022' %}; and {% cite 'Park et al. 2019' %}.
...
[^28]: {% cite 'Thibout 2020' '48–50' %}; {% cite 'Ganio et al. 2015' '9' %}.
...
[^31]: Egyptian, probably from Antinoöpolis, *Portrait of a Woman*, ca. 130–50 CE, encaustic on native sycomore fig, 35.3 x 22.5 x 2 cm (14 x 9 x 0.8 in.). Harvard Art Museums/Arthur M. Sackler Museum, 1923.60; {% cite 'Susanne Ebbinghaus et al. 2022' %}.
...
[^34]: Review of data available on APPEAR database. See also {% cite 'Thompson 1976' '115–19' %}.
