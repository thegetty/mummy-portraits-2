...
[^31]: Identification through vis-NIR FORS and FTIR for DIA painting (see APPEAR database). For wax identification in the Walters painting see {% cite 'Radpour et al. 2022' '8–9' %}; {% cite 'Ramer 1979' '6–7' %}; and {% cite 'Mazurek 2020' '142–47' %}.

[^32]: Egyptian, probably from Antinoöpolis, Portrait of a Woman, ca. 130–50 CE. Encaustic on native sycomore fig, 35.3 x 22.5 x 2 cm (14 x 9 x 7/8 in.). Harvard Art Museums/Arthur M. Sackler Museum, 1923.60. {% cite 'Ebbinghaus et al. 2022B' %}.
