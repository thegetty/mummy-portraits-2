...
Copper was detected by MA-XRF in the large green emeralds of the necklace and earrings in Portrait G ([fig. 12.15h](#fig-12-15-h)). The jewel located between two pearls on the earring in Portrait E has been previously described as a black bead.[^18] However, MA-XRF showed that a Cu-based pigment was used ([fig. 12.15g](#fig-12-15-g)) and examination under magnification confirmed that the color is greenish and achieved in two paint applications consisting of an opaque green paint layer followed by a translucent glaze, suggesting that this is an emerald. As aspects of the jewelry and hairstyle are frequently used as an aid in dating the portraits, confirming these details is critical.
...
MA-XRF mapping also revealed hidden features that contribute to the understanding of the portraits. For Portrait G*,* the Fe and Pb distribution maps showed a crescent moon hairpin ornament, as well as details of the sitter’s hairstyle, concealed by the gold (Au) leaf ([figs. 12.16a](#fig-12-16-a)–[c](#fig-12-16-c)). An important feature made more clearly visible by MA-XRF mapping is the amulet in the sitter’s necklace in Portrait I ([fig. 12.17](#fig-12-17-a)). Painted mainly with an ochre pigment revealed in the Fe distribution map ([figs. 12.17a](#fig-12-17-a) and [c](#fig-12-17-c)), it can now be identified with certainty as Omphale holding the club of Herakles ([fig. 12.17e](#fig-12-17-e)).[^20] Questions have been raised as to whether the necklace was added to this portrait at a later date. That it is surely original has been confirmed by the Fe and Cu distribution maps and examination of the surface under magnification. The necklace was painted first, followed by the blue mantle, the latter painted with a Cu-containing pigment ([figs. 12.17b](#fig-12-17-b)–[d](#fig-12-17-d)). MA-XRF detected As in this necklace where the artist used a bright yellow As-containing pigment, very possibly orpiment, to enhance the highlight. This is the only instance in which As was identified in the present study. In addition, Portrait I is the only one in this study in which MA-XRF detected Hg. Here, the artist applied a tiny dab of cinnabar to redden the caruncle membrane at the inner corner of both eyes.
