...
[^14]: $$Delaney et al. 2017, 15509$$; {% cite 'Dyer and Newman 2020' %}; {% cite 'Ganio et al. 2015' %}; {% cite 'Salvant et al. 2018' %}; {% cite 'Thiboutot 2020' %}; {% cite 'Vak, Iannaccone, and Uhlir 2020' %}.
